module ApplicationHelper
  ...
  GTL_VIEW_LAYOUTS = %w(action availability_zone cim_base_storage_extent cloud_tenant condition container_group
                        container_route container_project container_replicator container_image container_image_registry
                        container_topology container_dashboard middleware_topology
  ...
  def render_listnav_filename
    if @lastaction == "show_list" && !session[:menu_click] &&
       %w(container_node container_service ems_container container_group ems_cloud ems_cluster ems_middleware middleware_server
          middleware_deployment container_route container_project container_replicator container_image container_image_registry
      ...
      "vm"
             ...
             container_route container_project container_replicator container_image container_image_registry
             container_node container_service ems_cloud ems_container ems_cluster ems_infra
